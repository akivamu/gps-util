...
public class FakeDeviceInfoProvider implements DeviceInfoProvider {
    ...
    public FakeDeviceInfoProvider(DeviceInfo deviceInfo) {
    ...
    public int getSdkVersion() {
        return Integer.parseInt(deviceInfo.getSdkInt());
    }
    ...
    public String getUserAgentString() {
        return "Android-Finsky/" + gsfVersionProvider.getVendingVersionString(true) + " ("
                ...
                + ",sdk=" + Integer.parseInt(deviceInfo.getSdkInt())
                + ",device=" + Build.DEVICE
    ...
    private AndroidBuildProto getBuildProto() {
        return AndroidBuildProto.newBuilder()
                ...
                .setSdkVersion(Integer.parseInt(deviceInfo.getSdkInt()))
